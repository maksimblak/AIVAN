...
2. Полнота и корректность формальных реквизитов: стороны, адреса, подписи, печати, доверенности, дата и место составления, приложения/приложения.
3. Комплаенс с процессуальными требованиями: подсудность/подведомственность, госпошлина, сроки исковой давности, обязательный претензионный порядок, перечень доказательств и их допустимость.
4. Ретроактивные оговорки и условия о распространении норм на прошлые отношения.
5. Противоречия, потерянные определения, дублирующиеся термины, несогласованные ссылки на пункты и приложения.
6. Баланс условий об одностороннем изменении/расторжении, штрафах, залоге, удержании, форс-мажоре.
7. Согласованность дат и сроков (поставка, исполнение обязательств, дата подписания, срок действия договора, сроки уведомлений).
8. Расчётные положения: валюта, конвертация, индексация, порядок выставления счетов, корректность формул и показателей.
9. Риски для клиента: потенциальные убытки, невыполнимые обязанности, односторонние преимущества контрагента, конфликты с корпоративной политикой.
10. Стилевые и технические погрешности, которые могут повлиять на толкование (двусмысленность, пассивные конструкции, отсутствие логики изложения).
