...
QUICK_HINTS = {
    "first_message": "\U0001f4a1 <i>Попробуйте описать вашу юридическую ситуацию — я помогу найти решение</i>",
    "document_uploaded": "\U0001f4a1 <i>Я могу сделать краткую выжимку, найти риски или проанализировать документ</i>",
    "long_text": "\U0001f4c4 <i>Длинный текст? Попробуйте загрузить его файлом — я смогу лучше его проанализировать</i>",
    "general": "\U0001f4a1 <i>Напомню: могу ответить на юридический вопрос, найти практику и собрать проект документа.</i>",
}
