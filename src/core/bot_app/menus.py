...
async def handle_search_practice_callback(callback: CallbackQuery) -> None:
    ...
    try:
        ...
        practice_text_lines = [
            ...
            "",
            "💡 <b>Быстрый ответ</b>",
            "   └ 2-3 релевантных судебных решения",
            "   └ Краткий анализ применимости к вашей ситуации",
            "",
            "📊 <b>Детальный анализ</b>",
            "   └ 6+ примеров из судебной практики",
            "   └ Подробные рекомендации по действиям",
            "   └ Анализ шансов на успех",
            "",
            "📄 <b>Помощь с документами</b>",
            "   └ Рекомендации по составлению",
            "   └ Ссылки на успешные аргументы из практики",
            "",
            HEAVY_DIVIDER,
            "",
