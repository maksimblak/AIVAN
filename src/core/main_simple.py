...
async def handle_help_info_callback(callback: CallbackQuery):
    ...
    try:
        ...
        support_text = (
            ...
            "→ Откройте раздел \"Профиль\" в меню\n\n"
...
async def handle_document_processing(callback: CallbackQuery):
    ...
    try:
        ...
        message_text = (
            ...
            "• <b>Краткая выжимка документа</b> — превращает объёмные документы в короткие выжимки\n"
            "• <b>Риск-анализ</b> — находит опасные формулировки и проблемные места в договорах\n"
            "• <b>Анализ искового заявления</b> — оценивает правовую позицию, риски и рекомендации\n"
    ...
    try:
        ...
        detailed_descriptions = {
            "summarize": (
                ...
                "📊 <b>Результат:</b>\n"
                "• Краткая выжимка документа (1-3 страницы)\n"
            ...
            "lawsuit_analysis": (
                ...
                "⚙️ <b>Как это работает:</b>\n"
                "• Определяет требования иска и правовую позицию\n"
                "• Выявляет доказательства, сильные и слабые точки\n"
                "• Оценивает процессуальные риски и пробелы\n"
                "• Формирует рекомендации по доработке\n\n"
                "📊 <b>Результат:</b>\n"
                "• Краткое резюме и список требований\n"
                "• Правовое обоснование и доказательства\n"
                "• Сильные стороны, риски и недостающие элементы\n"
                "• Практические рекомендации к доработке\n\n"
                "💼 <b>Полезно для:</b>\n"
                "Проверки исков перед подачей, подготовки к судебным спорам\n\n"
                "📝 <b>Перед загрузкой подготовьте:</b>\n"
                "1. Финальную версию иска (PDF/DOCX).\n"
                "2. Приложения и ключевые доказательства (по возможности).\n"
                "3. Краткое описание ситуации — поможет точности анализа."
            ),
            "chat": (
