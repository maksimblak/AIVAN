...
def build_practice_excel(
    *,
    ...
    # Создаём таблицу практики как первый лист (по умолчанию активный)
    wb = Workbook()
    ws_cases = wb.active
    ws_cases.title = "Практика"
    ...
    # Лист "Обзор" с кратким выводом — вторым по порядку
