Production deployment quick start: see docs/DEPLOYMENT.md for the hardened runbook.
...
- **Распознание текста** - извлечение текста из изображений (PaddleOCR, Tesseract)
...
│   │   ├── ocr_converter.py   # модуль "распознание текста"
...
#### Windows
1. Установите [Tesseract](https://github.com/UB-Mannheim/tesseract/wiki) для задачи "распознание текста"
...
2. **Распознание текста** - автоматическое извлечение текста
...
- [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) за возможности для "распознание текста"
